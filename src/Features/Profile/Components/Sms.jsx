...
import styles from "../../../components/Check.module.css";
...
export default function Passwith() {
      ...
      <div className={style.Sms}>
        <div className={styles.border}>
          <div className={styles.double}>
            ...
            <h1 className={styles.h1}>Telefon raqamni yangilash</h1>
          </div>
        </div>
